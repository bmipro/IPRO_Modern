...
3. Pick a card design from the gallery — the live preview on the right updates as you choose. Choosing a design fills in that card's stock greeting for you; if you've already typed your own wording it's left alone.
4. Edit the email subject and message if you want. Both show directly on the card itself, so keep them brief.

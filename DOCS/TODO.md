...
| 403 | QA restart **day 3** (Aug 12): upgrade **QA Platinum (Daily), id 9** | No overnight charge to wait for (Gold cycles deferred to Sep 11). Owner: console override id 9 -> Upgrade Monthly. Verify: prorated invoice correct and charged once (this exercises the <= absorb fix), Gold sub CANCELLED at PayPal, Platinum ACTIVE at $94.50/day inclusive ($90+5%). |

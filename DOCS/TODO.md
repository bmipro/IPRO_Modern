...
| **447** | The flaky test, now identified | **IDENTIFIED 2026-09-02:** the flaky test is `SendClaimsTests.Retiring_a_poll_send_that_mailed_nobody_returns_the_survey_to_draft` -- failed once at 19s into a full parallel run, passed 3/3 alone. Almost certainly a shared-state race with a sibling test under parallel load; investigate the fixture, do not retry-loop it. |

...
public class DripCampaignEnrollment
{
    ...
    // TODO 448: the processing claim -- see DripEnrollmentClaims. ClaimedAt alone marks
    // ownership (no transient status, because every screen and sweep filters on Active).

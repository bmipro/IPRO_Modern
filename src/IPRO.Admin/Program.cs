...
static async Task EnsureWebsiteTemplateSchemaAsync(IPRODbContext db)
{
    ...
    try
    {
        ...
        // Shared with IPRO.Web (auditor 5, F4): this app used to carry a hand-copied SUBSET of the
        // BillingRules repairs -- it had the trial/waiver/template columns but was missing all ten
        // base pricing columns (MonthlyPrice through CreatedAt). The full list now lives once in
        // IPRO.DataAccess.BillingRuleSchema.

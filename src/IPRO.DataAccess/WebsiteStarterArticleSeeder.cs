        ...
        await SeedGuard.RunAsync(db, "WebsiteStarterArticles", logger, async () =>
        {
            ...
            var desired = new[]
            {
                Article("All", "How to Get the Most Out of Your First Meeting",
                    ...
                    "<p>Your first meeting is really just a conversation about where things stand and where you'd like to go. You don't need to have everything figured out beforehand — that's what we're here to help with — but a little preparation goes a long way.</p>" +
                    ...
                    "<p>It's also useful to think about your priorities in plain terms — not the \"right\" technical answer, just what feels most important to you right now. We'll bring the expertise; you bring the context only you have.</p>" +
                    "<p>There's no such thing as a question that's too basic. The goal of that first conversation is simply to understand your situation clearly enough to recommend a sensible next step — nothing more.</p>", 0),
                Article("All", "Questions Worth Asking Before You Choose an Advisor",
                    ...
                    "</ul>" +
                    "<p>We're always happy to answer these directly — feel free to ask any of them when we speak.</p>", 1),
                ...
                Article("Accountants", "Personal Financial Planning",
                    ...
                    "<p>A financial plan is only useful if it reflects your actual life, not a generic template. Our team works with you to build a plan around your specific goals, timeline, and circumstances — one that adapts as your situation changes rather than sitting untouched in a drawer.</p>" +
                    ...
                    "<li>Major life events — marriage, divorce, a new home</li>" +
                ...
                Article("Accountants", "Personal Tax Preparation",
                    ...
                    "<p>We handle personal tax preparation for individuals and families, and we make sure you're claiming everything you're entitled to — not just what's easiest to file. Below is a practical checklist of what to bring to your appointment.</p>" +
                    ...
                    "</ul>" +
                    "<p>Not sure if something on your desk counts? Bring it anyway — it's easier for us to set aside what you don't need than to chase down what's missing.</p>",
                    1, "Personal Accounting"),

                Article("Accountants", "General Ledger & Chart of Accounts",
                    "The backbone of your books — every account, transaction, and balance an accounting system relies on.",
                    "<p>A general ledger is the record that holds every account related to your business's assets, liabilities, owner's equity, revenue, and expenses. In any accounting system, it's the central repository everything else feeds into — accounts payable, accounts receivable, payroll, and more.</p>" +
                    ...
                    "<p>A well-kept general ledger usually breaks into seven main categories — assets, liabilities, owner's equity, revenue, expenses, gains, and losses — each of which can be further divided into sub-ledgers for things like cash, receivables, or payables.</p>" +
                ...
                Article("Accountants", "Accounts Receivable",
                    ...
                    "<p>Accounts receivable is the money owed to your business for goods or services already delivered — typically tracked through invoices sent to customers, who then pay within agreed terms.</p>" +
                    ...
                    "</ul>" +
                    "<p>Monthly reporting keeps you aware of what's outstanding before it becomes a cash flow issue — not after.</p>",
                    1, "Business Accounting"),
                Article("Accountants", "Accounts Payable",
                    "What you owe, tracked and paid on time — protecting your credit and your vendor relationships.",
                    ...
                    "<p>Managed well, accounts payable protects two things at once — your cash flow, by making sure you're not paying earlier than you need to, and your vendor relationships, by making sure you're never paying later than you should. Both matter more than they might seem.</p>" +
                ...
                Article("Accountants", "Bank Reconciliation",
                    "Making sure your books and your bank statement actually agree — and catching it quickly when they don't.",
                    "<p>A bank reconciliation explains the difference between the balance your bank shows and the balance your own books show at a given point in time. Differences are normal — a cheque that hasn't cleared yet, a bank fee that hasn't been recorded, or, occasionally, an error on either side.</p>" +
                    "<p>The value of reconciling regularly isn't just accuracy for its own sake. It's catching a problem — a missed transaction, a duplicate charge, an error — while it's still easy to trace, instead of months later when the trail has gone cold.</p>" +
                ...
                Article("Accountants", "Financial Statements",
                    ...
                    "<p>A financial statement is a formal record of your business's financial activity, prepared to give a clear picture of its position and performance — useful to you, to lenders, and to anyone else who needs to make a decision based on the numbers.</p>" +
                    "<p>Three statements do most of the work:</p>" +
                    "<ul>" +
                    "<li><strong>The income statement (P&L)</strong> — what you earned and spent over a period</li>" +
                    "<li><strong>The balance sheet</strong> — what you own and owe at a point in time</li>" +
                    "<li><strong>The cash flow statement</strong> — how cash actually moved in and out</li>" +
                    "</ul>" +
                    "<p>We prepare these monthly, quarterly, or annually depending on what you need — and we're glad to walk through what they actually mean for your business, not just hand you the numbers.</p>",
                ...
                Article("Accountants", "Customized Reporting",
                    ...
                    "<p>Every transaction entered into your bookkeeping system can be pulled back out in a form that's actually useful to you — not just a standard template.</p>" +
                    "<p>We build custom reports for tracking and analysis, including detailed trial balances and general ledger views to support tax reporting, along with whatever specific breakdown helps you see your business clearly — by client, by project, by month, or however makes the most sense for how you actually run things.</p>" +
                    "<p>If a standard report isn't answering the question you're actually asking, tell us the question — we'll build the report around it.</p>",
                    5, "Business Accounting"),
                Article("Accountants", "Tax Preparation",
                    "Personal, business, and payroll tax filing — handled by people who take the time to understand your situation first.",
                    ...
                    "</ul>" +
                    "<p>Have a question about your personal or business taxes? That's exactly what we're here for — reach out any time, not just at filing deadlines.</p>",
                ...
                Article("Accountants", "Payroll",
                    ...
                    "<p>Payroll is consistently one of the most time-consuming tasks in a business — and one of the least forgiving of mistakes. Outsourcing it frees up your time for work that actually grows the business, while making sure your team is paid accurately and on schedule.</p>" +
                    "<p>We manage:</p>" +
                    "<ul>" +
                    ...
                    "</ul>" +
                    "<p>Good employee morale depends on payroll being right, every time, without exception — that's the standard we hold ourselves to.</p>",
                    7, "Business Accounting"),
                Article("Accountants", "Should You Incorporate Your Small Business?",
                    "There's no universal right answer — but here are the real advantages worth weighing for your situation.",
                    "<p>Every small business owner eventually asks whether they should incorporate. There's no universal answer — it depends on your specific goals and circumstances — but here are the advantages worth weighing:</p>" +
                    "<ul>" +
                    "<li>Limited liability protection</li>" +
                    "<li>Continuity — the corporation carries on independent of its owners</li>" +
                ...
                Article("Accountants", "Bookkeeping Habits That Pay Off at Tax Time",
                    ...
                    "<p>Good bookkeeping isn't about doing more work — it's about doing a small amount of consistent work throughout the year, instead of a large amount all at once in April.</p>" +
                ...
                Article("Accountants", "What Is a Chartered Professional Accountant (CPA)?",
                    ...
                    "<p>A CPA has met rigorous education, examination, and experience requirements, and is required to maintain ongoing professional development to stay current — not a one-time credential, but an ongoing standard.</p>" +
                ...
                Article("Accountants", "What Is the CRA?",
                    "The federal agency behind Canada's tax system — and the one you're actually filing with every year.",
                    "<p>The Canada Revenue Agency (CRA) is the federal agency responsible for administering tax laws across Canada, for the federal government and most provinces and territories. Its role goes beyond collecting taxes — it also oversees charity registration, international trade rules, and various social and economic benefit programs delivered through the tax system.</p>" +
                    "<p>For most individuals and small businesses, the CRA is who you're actually dealing with at tax time — whether that's filing a return, responding to a request for information, or claiming a benefit you're entitled to. Having someone who understands how the CRA actually operates makes that relationship considerably less stressful.</p>",
                    1, "Info Centre"),
                Article("Accountants", "What Is the IRS?",
                    "The U.S. equivalent of the CRA — relevant if you have any American income, property, or business ties.",
                    ...
                    "<p>Cross-border tax situations are genuinely more complicated than domestic ones — the two systems don't always align, and filing requirements can catch people off guard. If any part of your financial life crosses the border, it's worth a conversation before it becomes a surprise.</p>",
                    2, "Info Centre"),
                Article("Accountants", "What Is Payroll?",
                    "More than a paycheck — it's a legal and financial responsibility with real consequences for getting it wrong.",
                    "<p>Payroll is the total of what a business pays its employees — wages, salaries, bonuses, and the deductions that come off each paycheck. It sounds administrative, but it carries real weight: payroll and payroll taxes directly affect your net income, and they're governed by specific legal requirements around withholding and remittance.</p>" +
                    "<p>There's a human side too. Employees notice payroll errors immediately, and inconsistent or late pay is one of the fastest ways to damage morale. Getting payroll right — accurately, and on time, every time — is a baseline expectation, not a nice-to-have.</p>",
                    3, "Info Centre"),
                Article("Accountants", "What Is Tax, Really?",
                    ...
                    "<p>What matters in practice is how tax touches your business at every stage — income tax on profit, payroll tax on wages, sales tax on what you sell, and the timing decisions that affect how much of it you owe and when. None of that is optional, but a surprising amount of it is plannable if you're paying attention before the deadline, not just at it.</p>" +
                    "<p>That planning — not just the filing — is where we spend most of our time with clients.</p>",
                    4, "Info Centre"),

                Article("Accountants", "Which Calculator Do You Actually Need?",
                    "A quick guide to picking the right tool from our calculators — and what each one actually tells you.",
                    ...
                    "<li><strong>Comparing loan offers?</strong> An APR calculator accounts for fees, not just the headline interest rate — the number that actually determines which offer is cheaper.</li>" +
                    ...
                    "<li><strong>Thinking about savings or investments?</strong> A compound interest calculator shows how growth compounds over time — often surprising people about how much time itself is worth.</li>" +
                    "</ul>" +
